...
public class AdminStatController {
    ...
    /**
     * 商品评论统计列表
     * API路径: GET /admin/stat/goods/comment
     */
    ...
    /**
     * 获取商品评论词云数据
     * API路径: GET /admin/stat/goods/wordcloud
     */
    @GetMapping("/goods/wordcloud")
    public Object getGoodsWordCloud(@RequestParam(required = false) Integer categoryId) {
        return statService.getGoodsWordCloud(categoryId);
    }
}
```
